...
const R0, V0 = 20., 1.
const ε0 = 1.0e-5
const ψ(r::Float64)   = OrbitalElements.ψMestelTrunc(r,R0,V0,ε0)
const dψ(r::Float64)  = OrbitalElements.dψMestelTrunc(r,R0,V0,ε0)
const d2ψ(r::Float64) = OrbitalElements.d2ψMestelTrunc(r,R0,V0,ε0)
const Ω₀ = OrbitalElements.Ω₀MestelTrunc(R0,V0,ε0)

##############################
# Outputs directories
##############################
const dirname   = "./../data/KineticTheory/SecularResponse/2024_03_26/"
...
const Orbitalparams = OrbitalElements.OrbitalParameters(;Ω₀=Ω₀,rmin=rmin)
...
const secdir = "./../data/KineticTheory/SecularResponse/2024_03_26/"

const Secularparams = SecularResponse.SecularParameters(basis;Linearparams=Linearparams,secdir=secdir,n1max=1,VERBOSE=0,Kv=99)